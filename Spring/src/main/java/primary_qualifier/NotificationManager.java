...
public class NotificationManager {
    ...
    @Autowired
    public NotificationManager(NotificationService primaryService, @Qualifier("emailNotificationService") NotificationService emailService, @Qualifier("pushNotificationService") NotificationService pushService) {
